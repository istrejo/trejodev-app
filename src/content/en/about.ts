...
export const about: AboutContent = {
  ...
  title: 'A frontend developer who turns product context into reliable interfaces.',
  description: 'Based in Tenerife, Spain, I build modern web and mobile experiences with React, Angular, TypeScript, Ionic and clean frontend architecture. My focus is simple: clear product thinking, maintainable UI systems and interfaces teams can trust.',
  paragraphs: [
  ...
  principles: ['Readable interfaces', 'Typed contracts', 'Performance awareness', 'Practical collaboration'],
};
