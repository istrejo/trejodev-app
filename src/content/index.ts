...
export const content = {
  en: { home: homeEn, about: aboutEn, experience: experienceEn, skills: skillsEn, certifications: certificationsEn, contact: contactEn },
  es: { home: homeEs, about: aboutEs, experience: experienceEs, skills: skillsEs, certifications: certificationsEs, contact: contactEs },
} as const;
