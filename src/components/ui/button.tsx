...
const variants = {
  ...
  secondary:
    "border border-line bg-paper text-ink hover:border-ink focus-visible:outline-ember",
  ghost:
    "text-ink underline decoration-line decoration-2 underline-offset-8 hover:decoration-ember focus-visible:outline-ember",
};
